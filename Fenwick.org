...
any performace downside to this change. The only restricition is that partial sums should be
sorted. I do not know if there is a better law that is equivalent to this. I believe they are all
more restrictive and disallow some perfect usecases of Fenwick trees.
